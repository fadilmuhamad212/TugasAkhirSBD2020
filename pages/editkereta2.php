...
{   
    ...
    // update user data
    $result = mysqli_query($koneksi, "UPDATE jakartasenen SET nama_kereta='$nama_kereta',jam_kedatangan='$jam_kedatangan',jam_keberangkatan='$jam_keberangkatan',estimasi_waktu='$estimasi_waktu',kelas_tersedia='$kelas_tersedia' WHERE id_kereta=$id_kereta");

    // Redirect to homepage to display updated user in list
    header("Location: datajadwaljakartasenen.php");
}
?>
<?php
...
$result = mysqli_query($koneksi, "SELECT * FROM jakartasenen WHERE id_kereta=$id_kereta");
...
<div class="bingkai">
    ...
    <form method="post" action="editkereta2.php">
        <table border="1">
            <tr> 
                <td>Id Masinis</td>
