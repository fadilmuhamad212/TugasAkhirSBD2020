...
?>
      				 <?php include_once("koneksi.php");
      				  $hasil = mysqli_query ($koneksi, "SELECT * FROM jogjakarta");
                        while ($baris = mysqli_fetch_assoc($hasil))
                  {
                      ...
                      <td align="center">
                      <a href="editkereta3.php?id_kereta=<?php echo $baris['id_kereta']; ?>">EDIT</a>
                      <a href="keretahapus3.php?id_kereta=<?php echo $baris['id_kereta']; ?>">HAPUS</a>
      						</td>
                      </tr>
                    <?php
                }
