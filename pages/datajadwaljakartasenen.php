...
?>
      				 <?php include_once("koneksi.php");
      				  $hasil = mysqli_query ($koneksi, "SELECT * FROM jakartasenen");
                        while ($baris = mysqli_fetch_assoc($hasil))
                  {
                      ...
                      <td align="center">
                      <a href="editkereta2.php?id_kereta=<?php echo $baris['id_kereta']; ?>">EDIT</a>
                      <a href="keretahapus2.php?id_kereta=<?php echo $baris['id_kereta']; ?>">HAPUS</a>
      						</td>
                      </tr>
                    <?php
                }
