		...
		<tr>
            ...
            <th>ID MASINIS</th>
      				 ...
      				 <?php include_once("koneksi.php");
      				  $hasil = mysqli_query ($koneksi, "SELECT jakartagambir.id_kereta, jakartagambir.nama_kereta, jakartagambir.jam_keberangkatan, masinis.nama_masinis,masinis.nip, masinis.id_masinis FROM masinis INNER JOIN jakartagambir ON masinis.id_masinis=jakartagambir.id_masinis");
